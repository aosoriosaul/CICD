Feature: /aclaraciones/busquedas/clientes POST
    ...
    Scenario Outline: /folios/busquedas 200 ok
        Given I set bearer token
        ...
        When I POST to `apigeeDomain`/operaciones-baz/plataforma-aclaraciones/administracion-aclaraciones/`deploymentSuffix`/aclaraciones/busquedas/clientes
        Then response code should be 200
        And response body should be valid json
    ...
    Examples:
        | body                                   |
        | {"id":"1234","idClienteBanco":"12345"} |


    Scenario Outline:  /folios/busquedas 400 bad request.
    ...
    Scenario Outline:  /folios/busquedas 401 bad request.
    ...
    Examples:
        | body                                |
        | {"id":"bad","idClienteBanco":"bad"} |

    Scenario Outline:  /folios/busquedas 404 not found.
    ...
    Examples:
        | body                              |
        | {"id":"nf","idClienteBanco":"nf"} |

    Scenario Outline:  /folios/busquedas 500 internal server error.
